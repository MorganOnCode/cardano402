// @cardano402/fastify — fastify adapter (scaffold).
//
// Planned surface (subject to refinement during Track D3):
//
//   import cardano402 from '@cardano402/fastify';
...
export function notImplemented(): never {
  throw new Error(
    '@cardano402/fastify is scaffolding only. Track D3 in cardano402-upgrade-plan.md.'
  );
}
