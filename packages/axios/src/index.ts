// @cardano402/axios — axios adapter (scaffold).
//
// Planned surface (subject to refinement during Track D3):
//
//   import cardano402 from '@cardano402/axios';
...
export function notImplemented(): never {
  throw new Error(
    '@cardano402/axios is scaffolding only. Track D3 in cardano402-upgrade-plan.md.'
  );
}
